...
/*
 * details for the movie Scheduling
 */
@Document
public class MovieSchedule {
	...
	public MovieSchedule(String theatreId, String theatreName, String email, String theatreLocation, String theatreCity,
			...
			int[] numberOfSeats, String id, String movieName, String moviePoster, String actors, String actress,
			String directors, String movieGenres, String synopsis, String format, String languages,
			String movieDuration, String movieReleaseDate, int showNumbers, String showTimings, int[] weekendsPrice,
			int[] weekdaysPrice) {
		super();
